...
@Component({
  ...
  templateUrl: './result-download.page.html',
  styleUrls: ['./result-download.page.scss'],
})
export class ResultDownloadPage implements OnInit {
  tab : any;
  phy : any;
  chem : any;
  math : any;  
  ...
  ngOnInit() {
    this.onLoader();
    this.list=[
      {tecname:'Demo1', chapter:'Exam', subtitle:'10%', type:'pdf'},
      {tecname:'Demo2', chapter:'Exam', subtitle:'11%', type:'pdf'},
      {tecname:'Demo3', chapter:'Exam', subtitle:'12%', type:'pdf'},
